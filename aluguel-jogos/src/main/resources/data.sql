...
INSERT INTO JOGO (nome, descricao, requisitos_sistema, desenvolvedor, publicador, genero, preco, imagem_url, em_destaque, no_carrossel)
VALUES ('Hades', 'Roguelike de ação', 'Intel i3, 4GB RAM', 'Supergiant Games', 'Supergiant Games', 'Roguelike', 49.90, 'https://meusite.com/imagens/hades.jpg', false, false);

INSERT INTO JOGO (nome, descricao, requisitos_sistema, desenvolvedor, publicador, genero, preco, imagem_url, em_destaque, no_carrossel)
VALUES ('Minecraft', 'Jogo de construção e sobrevivência', 'Intel i3, 2GB RAM', 'Mojang', 'Mojang', 'Sandbox', 119.90, 'https://meusite.com/imagens/minecraft.jpg', false, false);
